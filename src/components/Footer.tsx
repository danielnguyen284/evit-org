...
const navItems = [
  ...
  { label: 'RESOURCES', href: '/it-vendor-introduction' },
...
function SocialIcon({ label, children, href }: { label: string; children: React.ReactNode; href: string }) {
  return (
    <a href={href} aria-label={label} className={styles.socialLink} target="_blank" rel="noopener noreferrer">
      {children}
    </a>
  );
}
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.mapColumn}>
          <div className={styles.socials}>
            <SocialIcon label="Facebook" href="https://www.facebook.com/goglobalasia1/">
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <SocialIcon label="Podcast" href="https://creators.spotify.com/pod/profile/evit-organization/">
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <SocialIcon label="LinkedIn" href="https://www.linkedin.com/company/evit-org/?viewAsMember=true">
              <svg viewBox="0 0 24 24" aria-hidden="true">
