      ...
      <div className="max-w-[1200px] w-full mx-auto px-6 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
        ...
        <div className="flex-1 text-left">
          ...
          <div className="flex items-center gap-3.5 mt-6">
            <a href="#" className="flex items-center justify-center w-9 h-9 rounded-full border border-[#E30000] text-[#E30000] hover:bg-[#E30000] hover:text-white transition-all duration-300">
