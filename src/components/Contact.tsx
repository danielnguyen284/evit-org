        ...
        <div className="flex-1 text-left">
          ...
          <ul className="flex flex-col gap-4 mb-6 font-sans">
            <li className="flex items-center gap-3 text-white/95 text-xs sm:text-sm font-semibold">
              ...
              <span>82 Tu Hoa Cong Chua, Quang An, Tay Ho, Hanoi, Vietnam</span>
            </li>
            <li className="flex items-center gap-3 text-white/95 text-xs sm:text-sm font-semibold">
              <div className="flex items-center justify-center w-9 h-9 rounded-full bg-blue-bright/10 border border-blue-bright/20 shrink-0">
                <MailIcon />
              </div>
              <a href="mailto:info@evit-org.com" className="hover:text-blue-bright transition-colors">
                info@evit-org.com
              </a>
            </li>
            <li className="flex items-center gap-3 text-white/95 text-xs sm:text-sm font-semibold">
          ...
          <div className="flex items-center gap-3.5 mt-6">
            <a href="#" className="flex items-center justify-center w-9 h-9 rounded-full border border-red-bright text-red-bright hover:bg-red-bright hover:text-white transition-all duration-300">
